...
public:
	...
	static void initializeReflection(){
		...
		BaseResponse::declaredFields.emplace_back("code","int",1,"BaseResponse",(int*)(&_baseresponse_->code) - (int*)_baseresponse_);
		BaseResponse::declaredFields.emplace_back("message","string",6,"BaseResponse",(int*)(&_baseresponse_->message) - (int*)_baseresponse_);
		BaseResponse::declaredFields.emplace_back("innerClass","InnerClass*",8,"BaseResponse",(int*)(&_baseresponse_->innerClass) - (int*)_baseresponse_);
		BaseResponse::declaredFields.emplace_back("sum","int",1,"BaseResponse",(int*)(&_baseresponse_->sum) - (int*)_baseresponse_);
		free(_baseresponse_);
	}
};
