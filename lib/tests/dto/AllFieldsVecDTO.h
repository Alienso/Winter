...
public:
    ...
    static void initializeReflection(){
        ...
        AllFieldsVecDTO::declaredFields.emplace_back("str","vector<std::string>",9,"AllFieldsVecDTO",(int*)(&_allfieldsvecdto_->str) - (int*)_allfieldsvecdto_,0,1);
        ...
        AllFieldsVecDTO::declaredFields.emplace_back("bt","vector<std::byte>",9,"AllFieldsVecDTO",(int*)(&_allfieldsvecdto_->bt) - (int*)_allfieldsvecdto_,0,1);
        ...
        AllFieldsVecDTO::declaredFields.emplace_back("strPtr","vector<std::string*>",9,"AllFieldsVecDTO",(int*)(&_allfieldsvecdto_->strPtr) - (int*)_allfieldsvecdto_,0,1);
        ...
        AllFieldsVecDTO::declaredFields.emplace_back("btPtr","vector<std::byte*>",9,"AllFieldsVecDTO",(int*)(&_allfieldsvecdto_->btPtr) - (int*)_allfieldsvecdto_,0,1);
        ...
        AllFieldsVecDTO::declaredFields.emplace_back("vecPtrString","vector<std::string>*",9,"AllFieldsVecDTO",(int*)(&_allfieldsvecdto_->vecPtrString) - (int*)_allfieldsvecdto_,1,1);
        AllFieldsVecDTO::declaredFields.emplace_back("vecPtrStringPtr","vector<std::string*>*",9,"AllFieldsVecDTO",(int*)(&_allfieldsvecdto_->vecPtrStringPtr) - (int*)_allfieldsvecdto_,1,1);
