...
HttpResponse *MyController::home(HttpRequest *httpRequest) {
    ...
    //Do some logic
    wtLogInfo("Received data: number={}, type={}", request->number, request->type.data());
    wtLogInfo("InnerClass: x={}, y={}, c={}", request->innerClass->x, request->innerClass->y, request->innerClass->c.data());
